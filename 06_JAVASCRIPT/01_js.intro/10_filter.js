...
const STRONG_STUDENTS = STUDENTS.filter( students => students.type == 'female')
...
// filter Helper를 사용해서 numbers 배열 중 50보다 큰 값만 필터링해서 새로운
// 배열에 저장하기

const numbers = [12, 35, 13, 36, 69, 3, 61, 55, 99, 5]
